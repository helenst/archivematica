...
function optimizeWidth() {
  ...
  if (1020 > width)
  {
    $(document.body).addClass('w-lte-1020').removeClass('w-lte-1200');//.className = 'w-lte-1020';
  }
  else if (1200 > width)
  {
    $(document.body).addClass('w-lte-1200').removeClass('w-lte-1020');//.className = 'w-lte-1020';
  }
  else
  {
